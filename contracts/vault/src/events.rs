...
pub fn emit_deposited(env: &Env, parent: &Address, amount: i128) {
    env.events()
        .publish((Symbol::new(env, "deposited"),), (parent.clone(), amount));
}
